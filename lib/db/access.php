...
$capabilities = array(
	...
	/* review course checkoutments - no group restrictions, it is really full access to all participants info*/
	'moodle/course:checkoutreview' => array(
	...
	/* add, remove, hide checkout instances in courses */
	'moodle/course:checkoutconfig' => array(
	...
	/* review course ordertotments - no group restrictions, it is really full access to all participants info*/
	'moodle/course:ordertotreview' => array(
	...
	/* add, remove, hide ordertot instances in courses */
	'moodle/course:ordertotconfig' => array(
	...
	/* review course paygatements - no group restrictions, it is really full access to all participants info*/
	'moodle/course:paygatereview' => array(
	...
	/* add, remove, hide paygate instances in courses */
	'moodle/course:paygateconfig' => array(
	...
	/* review course prodinfoments - no group restrictions, it is really full access to all participants info*/
	'moodle/course:prodinforeview' => array(
	...
	/* add, remove, hide prodinfo instances in courses */
	'moodle/course:prodinfoconfig' => array(
	...
	/* review course shippingments - no group restrictions, it is really full access to all participants info*/
	'moodle/course:shippingreview' => array(
	...
	/* add, remove, hide shipping instances in courses */
	'moodle/course:shippingconfig' => array(
