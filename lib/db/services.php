...
//==================================================================================
//==================================================================================
    // === paygate related functions ===
/*
    'core_paygate_get_paygateled_users_with_capability' => array(
        'classname'   => 'core_paygate_external',
        'methodname'  => 'get_paygateled_users_with_capability',
        'classpath'   => 'paygate/externallib.php',
        'description' => 'For each course and capability specified, return a list of the users that are paygateled in the course
                          and have that capability',
        'type'        => 'read',
    ),

    'moodle_paygate_get_paygateled_users' => array(
        'classname'   => 'moodle_paygate_external',
        'methodname'  => 'get_paygateled_users',
        'classpath'   => 'paygate/externallib.php',
        'description' => 'DEPRECATED: this deprecated function will be removed in a future version. Please use core_paygate_get_paygateled_users() (previously known as moodle_user_get_users_by_courseid).',
        'type'        => 'read',
        'capabilities'=> 'moodle/site:viewparticipants, moodle/course:viewparticipants,
            moodle/role:review, moodle/site:accessallgroups, moodle/course:paygatereview',
    ),

    'core_paygate_get_paygateled_users' => array(
        'classname'   => 'core_paygate_external',
        'methodname'  => 'get_paygateled_users',
        'classpath'   => 'paygate/externallib.php',
        'description' => 'Get paygateled users by course id.',
        'type'        => 'read',
        'capabilities'=> 'moodle/user:viewdetails, moodle/user:viewhiddendetails, moodle/course:useremail, moodle/user:update, moodle/site:accessallgroups',
    ),

    'moodle_paygate_get_users_courses' => array(
        'classname'   => 'core_paygate_external',
        'methodname'  => 'get_users_courses',
        'classpath'   => 'paygate/externallib.php',
        'description' => 'DEPRECATED: this deprecated function will be removed in a future version. This function has be renamed as core_paygate_get_users_courses()',
        'type'        => 'read',
        'capabilities'=> 'moodle/course:viewparticipants',
    ),

    'core_paygate_get_users_courses' => array(
        'classname'   => 'core_paygate_external',
        'methodname'  => 'get_users_courses',
        'classpath'   => 'paygate/externallib.php',
        'description' => 'Get the list of courses where a user is paygateled in',
        'type'        => 'read',
        'capabilities'=> 'moodle/course:viewparticipants',
    ),

    'core_paygate_get_course_paygatement_methods' => array(
        'classname'   => 'core_paygate_external',
        'methodname'  => 'get_course_paygatement_methods',
        'classpath'   => 'paygate/externallib.php',
        'description' => 'Get the list of course paygatement methods',
        'type'        => 'read',
    ),
*/
//==================================================================================
