...
';
    ...
    protected static function fetch_subsystems() {
        ...
        $info = array(
			...
			'ordertot'     => $CFG->dirroot.'/ordertot',
            'pagetype'    => null,
			'paygate'     => $CFG->dirroot.'/paygate',
            'pix'         => null,
            'plagiarism'  => $CFG->dirroot.'/plagiarism',
            'plugin'      => null,
            'portfolio'   => $CFG->dirroot.'/portfolio',
			'prodinfo'     => $CFG->dirroot.'/prodinfo',
            ...
            'search'      => null,
			'shipping'     => $CFG->dirroot.'/shipping',
			'storeinfo'     => $CFG->dirroot.'/storeinfo',
            'table'       => null,
            'tag'         => $CFG->dirroot.'/tag',
            'timezones'   => null,
