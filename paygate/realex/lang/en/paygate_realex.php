...
/**
 * Strings for component 'paygate_realex', language 'en'.
 *
...
$string['realex:manage'] = 'Manage user paymentgatways manually';
$string['realex:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:realex_paymentgatway'] = 'realex paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'realex';
