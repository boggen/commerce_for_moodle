...
/**
 * Strings for component 'paygate_perpetua', language 'en'.
 *
...
$string['perpetua:manage'] = 'Manage user paymentgatways manually';
$string['perpetua:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:perpetua_paymentgatway'] = 'perpetua paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'perpetual payments';
