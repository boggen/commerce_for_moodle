...
/**
 * Strings for component 'paygate_securepp', language 'en'.
 *
...
$string['securepp:manage'] = 'Manage user paymentgatways manually';
$string['securepp:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:securepp_paymentgatway'] = 'securepp paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'securetrading pp';
