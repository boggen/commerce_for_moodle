...
/**
 * Strings for component 'paygate_pppro', language 'en'.
 *
...
$string['pppro:manage'] = 'Manage user paymentgatways manually';
$string['pppro:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:pppro_paymentgatway'] = 'pppro paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paypal pro';
