...
/**
 * pppro paymentgatway plugin.
 *
 * This plugin lets the user specify a "pppro" (CSV) containing paymentgatway information.
...
/**
 * pppro paymentgatway plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class paygate_pppro_plugin extends paygate_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('paygate/pppro:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for pppro paymentgatways in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'paygate/pppro:manage'
    ...
    protected function get_paygateler($courseid) {
        ...
        $users = get_paygateled_users($context, 'paygate/pppro:manage');
        if (!$users) {
