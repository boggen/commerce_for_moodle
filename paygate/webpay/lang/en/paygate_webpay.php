...
/**
 * Strings for component 'paygate_webpay', language 'en'.
 *
...
$string['webpay:manage'] = 'Manage user paymentgatways manually';
$string['webpay:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:webpay_paymentgatway'] = 'webpay paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'web payment software';
