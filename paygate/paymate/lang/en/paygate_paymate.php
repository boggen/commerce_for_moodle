...
/**
 * Strings for component 'paygate_paymate', language 'en'.
 *
...
$string['paymate:manage'] = 'Manage user paymentgatways manually';
$string['paymate:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:paymate_paymentgatway'] = 'paymate paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paymate';
