 ...
 */
class paygate_securews_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_securews/map_'.$role->id, $role->localname, '', $role->shortname);
    }
