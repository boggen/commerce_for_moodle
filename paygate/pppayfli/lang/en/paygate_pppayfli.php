...
/**
 * Strings for component 'paygate_pppayfli', language 'en'.
 *
...
$string['pppayfli:manage'] = 'Manage user paymentgatways manually';
$string['pppayfli:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:pppayfli_paymentgatway'] = 'pppayfli paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paypal payflow iframe';
