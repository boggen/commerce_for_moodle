...
/**
 * Strings for component 'paygate_klarnaac', language 'en'.
 *
...
$string['klarnaac:manage'] = 'Manage user paymentgatways manually';
$string['klarnaac:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:klarnaac_paymentgatway'] = 'klarnaac paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'klarna account';
