 ...
 */
class paygate_klarnaac_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_klarnaac/map_'.$role->id, $role->localname, '', $role->shortname);
    }
