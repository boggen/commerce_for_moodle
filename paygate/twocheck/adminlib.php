 ...
 */
class paygate_twocheck_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_twocheck/map_'.$role->id, $role->localname, '', $role->shortname);
    }
