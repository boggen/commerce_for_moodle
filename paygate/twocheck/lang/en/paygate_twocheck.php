...
/**
 * Strings for component 'paygate_twocheck', language 'en'.
 *
...
$string['twocheck:manage'] = 'Manage user paymentgatways manually';
$string['twocheck:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:twocheck_paymentgatway'] = 'twocheck paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'twocheckout';
