...
/**
 * Strings for component 'paygate_worldpay', language 'en'.
 *
...
$string['worldpay:manage'] = 'Manage user paymentgatways manually';
$string['worldpay:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:worldpay_paymentgatway'] = 'worldpay paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'worldpay';
