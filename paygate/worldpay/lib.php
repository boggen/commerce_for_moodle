...
/**
 * worldpay paymentgatway plugin.
 *
 * This plugin lets the user specify a "worldpay" (CSV) containing paymentgatway information.
...
/**
 * worldpay paymentgatway plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class paygate_worldpay_plugin extends paygate_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('paygate/worldpay:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for worldpay paymentgatways in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'paygate/worldpay:manage'
    ...
    protected function get_paygateler($courseid) {
        ...
        $users = get_paygateled_users($context, 'paygate/worldpay:manage');
        if (!$users) {
