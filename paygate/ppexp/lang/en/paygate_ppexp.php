...
/**
 * Strings for component 'paygate_ppexp', language 'en'.
 *
...
$string['ppexp:manage'] = 'Manage user paymentgatways manually';
$string['ppexp:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:ppexp_paymentgatway'] = 'ppexp paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paypal express';
