 ...
 */
class paygate_ppexp_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_ppexp/map_'.$role->id, $role->localname, '', $role->shortname);
    }
