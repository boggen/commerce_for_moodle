...
/**
 * ppexp paymentgatway plugin.
 *
 * This plugin lets the user specify a "ppexp" (CSV) containing paymentgatway information.
...
/**
 * ppexp paymentgatway plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class paygate_ppexp_plugin extends paygate_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('paygate/ppexp:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for ppexp paymentgatways in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'paygate/ppexp:manage'
    ...
    protected function get_paygateler($courseid) {
        ...
        $users = get_paygateled_users($context, 'paygate/ppexp:manage');
        if (!$users) {
