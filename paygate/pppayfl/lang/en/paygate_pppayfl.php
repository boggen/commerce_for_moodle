...
/**
 * Strings for component 'paygate_pppayfl', language 'en'.
 *
...
$string['pppayfl:manage'] = 'Manage user paymentgatways manually';
$string['pppayfl:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:pppayfl_paymentgatway'] = 'pppayfl paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paypal payflow';
