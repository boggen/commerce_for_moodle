...
/**
 * Strings for component 'paygate_authaim', language 'en'.
 *
...
$string['authaim:manage'] = 'Manage user paymentgatways manually';
$string['authaim:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:authaim_paymentgatway'] = 'authaim paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'autherizenet aim';
