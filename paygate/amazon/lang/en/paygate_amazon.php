...
/**
 * Strings for component 'paygate_amazon', language 'en'.
 *
...
$string['amazon:manage'] = 'Manage user paymentgatways manually';
$string['amazon:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:amazon_paymentgatway'] = 'amazon paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'amazon checkout';
