 ...
 */
class paygate_ppproi_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_ppproi/map_'.$role->id, $role->localname, '', $role->shortname);
    }
