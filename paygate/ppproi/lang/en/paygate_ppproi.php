...
/**
 * Strings for component 'paygate_ppproi', language 'en'.
 *
...
$string['ppproi:manage'] = 'Manage user paymentgatways manually';
$string['ppproi:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:ppproi_paymentgatway'] = 'ppproi paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paypal pro iframe';
