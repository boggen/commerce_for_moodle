...
/**
 * Strings for component 'paygate_firdatare', language 'en'.
 *
...
$string['firdatare:manage'] = 'Manage user paymentgatways manually';
$string['firdatare:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:firdatare_paymentgatway'] = 'firdatare paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'first data remote';
