...
/**
 * Strings for component 'paygate_freechec', language 'en'.
 *
...
$string['freechec:manage'] = 'Manage user paymentgatways manually';
$string['freechec:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:freechec_paymentgatway'] = 'freechec paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'free check out';
