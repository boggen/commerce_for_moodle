...
/**
 * bluepayh paymentgatway plugin.
 *
 * This plugin lets the user specify a "bluepayh" (CSV) containing paymentgatway information.
...
/**
 * bluepayh paymentgatway plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class paygate_bluepayh_plugin extends paygate_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('paygate/bluepayh:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for bluepayh paymentgatways in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'paygate/bluepayh:manage'
    ...
    protected function get_paygateler($courseid) {
        ...
        $users = get_paygateled_users($context, 'paygate/bluepayh:manage');
        if (!$users) {
