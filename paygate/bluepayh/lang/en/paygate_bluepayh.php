...
/**
 * Strings for component 'paygate_bluepayh', language 'en'.
 *
...
$string['bluepayh:manage'] = 'Manage user paymentgatways manually';
$string['bluepayh:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:bluepayh_paymentgatway'] = 'bluepayh paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'bluepay host';
