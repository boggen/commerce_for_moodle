...
/**
 * Strings for component 'paygate_authsim', language 'en'.
 *
...
$string['authsim:manage'] = 'Manage user paymentgatways manually';
$string['authsim:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:authsim_paymentgatway'] = 'authsim paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'autherizenet sim';
