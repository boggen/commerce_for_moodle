...
/**
 * Strings for component 'paygate_cheque', language 'en'.
 *
...
$string['cheque:manage'] = 'Manage user paymentgatways manually';
$string['cheque:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:cheque_paymentgatway'] = 'cheque paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'cheque';
