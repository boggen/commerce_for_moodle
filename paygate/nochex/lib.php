...
/**
 * nochex paymentgatway plugin.
 *
 * This plugin lets the user specify a "nochex" (CSV) containing paymentgatway information.
...
/**
 * nochex paymentgatway plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class paygate_nochex_plugin extends paygate_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('paygate/nochex:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for nochex paymentgatways in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'paygate/nochex:manage'
    ...
    protected function get_paygateler($courseid) {
        ...
        $users = get_paygateled_users($context, 'paygate/nochex:manage');
        if (!$users) {
