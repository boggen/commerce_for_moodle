...
/**
 * Strings for component 'paygate_nochex', language 'en'.
 *
...
$string['nochex:manage'] = 'Manage user paymentgatways manually';
$string['nochex:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:nochex_paymentgatway'] = 'nochex paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'nochex';
