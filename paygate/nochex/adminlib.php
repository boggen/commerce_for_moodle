 ...
 */
class paygate_nochex_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_nochex/map_'.$role->id, $role->localname, '', $role->shortname);
    }
