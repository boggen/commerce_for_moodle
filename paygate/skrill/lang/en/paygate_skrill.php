...
/**
 * Strings for component 'paygate_skrill', language 'en'.
 *
...
$string['skrill:manage'] = 'Manage user paymentgatways manually';
$string['skrill:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:skrill_paymentgatway'] = 'skrill paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'skrill';
