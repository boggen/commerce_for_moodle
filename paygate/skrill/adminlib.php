 ...
 */
class paygate_skrill_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_skrill/map_'.$role->id, $role->localname, '', $role->shortname);
    }
