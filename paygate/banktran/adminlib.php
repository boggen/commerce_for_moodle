 ...
 */
class paygate_banktran_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_banktran/map_'.$role->id, $role->localname, '', $role->shortname);
    }
