...
/**
 * Strings for component 'paygate_banktran', language 'en'.
 *
...
$string['banktran:manage'] = 'Manage user paymentgatways manually';
$string['banktran:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:banktran_paymentgatway'] = 'banktran paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'banktran';
