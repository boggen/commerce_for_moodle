...
/**
 * Strings for component 'paygate_bluepayr', language 'en'.
 *
...
$string['bluepayr:manage'] = 'Manage user paymentgatways manually';
$string['bluepayr:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:bluepayr_paymentgatway'] = 'bluepayr paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'bluepay redirected';
