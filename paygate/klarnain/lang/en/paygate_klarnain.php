...
/**
 * Strings for component 'paygate_klarnain', language 'en'.
 *
...
$string['klarnain:manage'] = 'Manage user paymentgatways manually';
$string['klarnain:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:klarnain_paymentgatway'] = 'klarnain paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'klarna invoice';
