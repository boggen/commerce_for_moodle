...
/**
 * Strings for component 'paygate_paypoint', language 'en'.
 *
...
$string['paypoint:manage'] = 'Manage user paymentgatways manually';
$string['paypoint:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:paypoint_paymentgatway'] = 'paypoint paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paypoint';
