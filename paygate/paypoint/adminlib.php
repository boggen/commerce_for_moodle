 ...
 */
class paygate_paypoint_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_paypoint/map_'.$role->id, $role->localname, '', $role->shortname);
    }
