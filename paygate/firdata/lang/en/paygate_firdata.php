...
/**
 * Strings for component 'paygate_firdata', language 'en'.
 *
...
$string['firdata:manage'] = 'Manage user paymentgatways manually';
$string['firdata:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:firdata_paymentgatway'] = 'firdata paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'first data';
