...
/**
 * Strings for component 'paygate_sagepays', language 'en'.
 *
...
$string['sagepays:manage'] = 'Manage user paymentgatways manually';
$string['sagepays:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:sagepays_paymentgatway'] = 'sagepays paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'sagepay server';
