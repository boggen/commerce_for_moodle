...
/**
 * sagepays paymentgatway plugin.
 *
 * This plugin lets the user specify a "sagepays" (CSV) containing paymentgatway information.
...
/**
 * sagepays paymentgatway plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class paygate_sagepays_plugin extends paygate_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('paygate/sagepays:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for sagepays paymentgatways in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'paygate/sagepays:manage'
    ...
    protected function get_paygateler($courseid) {
        ...
        $users = get_paygateled_users($context, 'paygate/sagepays:manage');
        if (!$users) {
