...
/**
 * Strings for component 'paygate_sagepayd', language 'en'.
 *
...
$string['sagepayd:manage'] = 'Manage user paymentgatways manually';
$string['sagepayd:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:sagepayd_paymentgatway'] = 'sagepayd paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'sagepay direct';
