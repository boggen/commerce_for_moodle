 ...
 */
class paygate_liqpay_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_liqpay/map_'.$role->id, $role->localname, '', $role->shortname);
    }
