...
/**
 * Strings for component 'paygate_liqpay', language 'en'.
 *
...
$string['liqpay:manage'] = 'Manage user paymentgatways manually';
$string['liqpay:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:liqpay_paymentgatway'] = 'liqpay paymentgatway messages';
