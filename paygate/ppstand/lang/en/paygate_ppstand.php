...
/**
 * Strings for component 'paygate_ppstand', language 'en'.
 *
...
$string['ppstand:manage'] = 'Manage user paymentgatways manually';
$string['ppstand:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:ppstand_paymentgatway'] = 'ppstand paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'paypal standard';
