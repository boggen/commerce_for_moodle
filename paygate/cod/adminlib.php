 ...
 */
class paygate_cod_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_cod/map_'.$role->id, $role->localname, '', $role->shortname);
    }
