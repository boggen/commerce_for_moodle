...
/**
 * Strings for component 'paygate_cod', language 'en'.
 *
 * @package    paygate_cod
...
$string['cod:manage'] = 'Manage user paymentgatways manually';
$string['cod:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:cod_paymentgatway'] = 'cod paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'cod';
