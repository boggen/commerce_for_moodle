...
/**
 * Strings for component 'paygate_sagepayu', language 'en'.
 *
...
$string['sagepayu:manage'] = 'Manage user paymentgatways manually';
$string['sagepayu:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:sagepayu_paymentgatway'] = 'sagepayu paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'sagepay us';
