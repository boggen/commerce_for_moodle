 ...
 */
class paygate_sagepayu_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('paygate_sagepayu/map_'.$role->id, $role->localname, '', $role->shortname);
    }
