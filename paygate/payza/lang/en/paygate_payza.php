...
/**
 * Strings for component 'paygate_payza', language 'en'.
 *
...
$string['payza:manage'] = 'Manage user paymentgatways manually';
$string['payza:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:payza_paymentgatway'] = 'payza paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'payza';
