...
/**
 * Strings for component 'paygate_realexr', language 'en'.
 *
...
$string['realexr:manage'] = 'Manage user paymentgatways manually';
$string['realexr:unpaygate'] = 'Unpaygate users from the course manually';
...
$string['messageprovider:realexr_paymentgatway'] = 'realexr paymentgatway messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'realex remote';
