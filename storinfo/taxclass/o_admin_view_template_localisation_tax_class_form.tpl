            ...
            <tbody>
              ...
              <tr id="tax-rule-row<?php echo $tax_rule_row; ?>">
                ...
                <td class="text-left"><select name="tax_rule[<?php echo $tax_rule_row; ?>][based]" class="form-control">
                    <?php  if ($tax_rule['based'] == 'storinfo') { ?>
                    <option value="storinfo" selected="selected"><?php echo $text_storinfo; ?></option>
                    <?php } else { ?>
                    <option value="storinfo"><?php echo $text_storinfo; ?></option>
                    <?php } ?>
...
function addRule() {
    ...
    html += '    <option value="storinfo"><?php echo $text_storinfo; ?></option>';
