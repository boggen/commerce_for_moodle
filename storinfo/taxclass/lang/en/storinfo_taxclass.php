...
/**
 * Strings for component 'storinfo_taxclass', language 'en'.
 *
...
$string['taxclass:manage'] = 'Manage user storemultiinfos manually';
$string['taxclass:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:taxclass_storemultiinfo'] = 'taxclass storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'taxclass';
