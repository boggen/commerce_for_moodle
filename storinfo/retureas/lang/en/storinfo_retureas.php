...
/**
 * Strings for component 'storinfo_retureas', language 'en'.
 *
...
$string['retureas:manage'] = 'Manage user storemultiinfos manually';
$string['retureas:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:retureas_storemultiinfo'] = 'retureas storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'return reason';
