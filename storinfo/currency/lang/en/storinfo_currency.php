...
/**
 * Strings for component 'storinfo_currency', language 'en'.
 *
...
$string['currency:manage'] = 'Manage user storemultiinfos manually';
$string['currency:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:currency_storemultiinfo'] = 'currency storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'currency';
