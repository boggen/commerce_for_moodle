...
/**
 * Strings for component 'storinfo_zonegeo', language 'en'.
 *
...
$string['zonegeo:manage'] = 'Manage user storemultiinfos manually';
$string['zonegeo:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:zonegeo_storemultiinfo'] = 'zonegeo storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'zonegeo';
