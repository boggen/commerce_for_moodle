 ...
 */
class storinfo_zonegeo_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('storinfo_zonegeo/map_'.$role->id, $role->localname, '', $role->shortname);
    }
