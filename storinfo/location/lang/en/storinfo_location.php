...
/**
 * Strings for component 'storinfo_location', language 'en'.
 *
...
$string['location:manage'] = 'Manage user storemultiinfos manually';
$string['location:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:location_storemultiinfo'] = 'location storemultiinfo messages';
