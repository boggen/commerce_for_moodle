...
/**
 * Strings for component 'storinfo_statretu', language 'en'.
 *
...
$string['statretu:manage'] = 'Manage user storemultiinfos manually';
$string['statretu:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:statretu_storemultiinfo'] = 'statretu storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'return status';
