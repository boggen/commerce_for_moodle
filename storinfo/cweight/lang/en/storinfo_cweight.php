...
/**
 * Strings for component 'storinfo_cweight', language 'en'.
 *
...
$string['cweight:manage'] = 'Manage user storemultiinfos manually';
$string['cweight:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['notifystorinfoled'] = 'Notify storinfoled users';
$string['notifystorinfoler'] = 'Notify user responsible for storemultiinfos';
$string['messageprovider:cweight_storemultiinfo'] = 'cweight storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'weight class';
