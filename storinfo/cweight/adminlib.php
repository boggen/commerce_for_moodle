 ...
 */
class storinfo_cweight_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('storinfo_cweight/map_'.$role->id, $role->localname, '', $role->shortname);
    }
