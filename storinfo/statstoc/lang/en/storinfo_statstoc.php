...
/**
 * Strings for component 'storinfo_statstoc', language 'en'.
 *
...
$string['statstoc:manage'] = 'Manage user storemultiinfos manually';
$string['statstoc:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:statstoc_storemultiinfo'] = 'statstoc storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'stock status';
