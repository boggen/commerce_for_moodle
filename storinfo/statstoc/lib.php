 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class storinfo_statstoc_plugin extends storinfo_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('storinfo/statstoc:manage', $context);
    }
     ...
     * as defined by sort_by_roleassignment_authority() having 'storinfo/statstoc:manage'
    ...
    protected function get_storinfoler($courseid) {
        ...
        $users = get_storinfoled_users($context, 'storinfo/statstoc:manage');
        if (!$users) {
