...
/**
 * Strings for component 'storinfo_retuacti', language 'en'.
 *
...
$string['retuacti:manage'] = 'Manage user storemultiinfos manually';
$string['retuacti:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:retuacti_storemultiinfo'] = 'retuacti storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'return action';
