...
/**
 * Strings for component 'storinfo_zone', language 'en'.
 *
...
$string['zone:manage'] = 'Manage user storemultiinfos manually';
$string['zone:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:zone_storemultiinfo'] = 'zone storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'zone';
