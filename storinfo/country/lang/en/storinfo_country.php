...
/**
 * Strings for component 'storinfo_country', language 'en'.
 *
...
$string['country:manage'] = 'Manage user storemultiinfos manually';
$string['country:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:country_storemultiinfo'] = 'country storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'country';
