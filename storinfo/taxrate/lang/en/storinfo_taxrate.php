...
/**
 * Strings for component 'storinfo_taxrate', language 'en'.
 *
...
$string['taxrate:manage'] = 'Manage user storemultiinfos manually';
$string['taxrate:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:taxrate_storemultiinfo'] = 'taxrate storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'taxrate';
