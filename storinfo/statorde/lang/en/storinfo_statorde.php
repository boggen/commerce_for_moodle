...
/**
 * Strings for component 'storinfo_statorde', language 'en'.
 *
...
$string['statorde:manage'] = 'Manage user storemultiinfos manually';
$string['statorde:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:statorde_storemultiinfo'] = 'statorde storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'order status';
