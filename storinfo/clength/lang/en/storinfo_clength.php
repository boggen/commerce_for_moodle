...
/**
 * Strings for component 'storinfo_clength', language 'en'.
 *
...
$string['clength:manage'] = 'Manage user storemultiinfos manually';
$string['clength:unstorinfo'] = 'Unstorinfo users from the course manually';
...
$string['messageprovider:clength_storemultiinfo'] = 'clength storemultiinfo messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'length class';
