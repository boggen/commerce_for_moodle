 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class storinfo_clength_plugin extends storinfo_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('storinfo/clength:manage', $context);
    }
     ...
     * as defined by sort_by_roleassignment_authority() having 'storinfo/clength:manage'
    ...
    protected function get_storinfoler($courseid) {
        ...
        $users = get_storinfoled_users($context, 'storinfo/clength:manage');
        if (!$users) {
