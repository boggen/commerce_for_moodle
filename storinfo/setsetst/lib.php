 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class storinfo_setsetst_plugin extends storinfo_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('storinfo/setsetst:manage', $context);
    }
     ...
     * as defined by sort_by_roleassignment_authority() having 'storinfo/setsetst:manage'
    ...
    protected function get_storinfoler($courseid) {
        ...
        $users = get_storinfoled_users($context, 'storinfo/setsetst:manage');
        if (!$users) {
