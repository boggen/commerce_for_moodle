...
/**
 * Strings for component 'ordertot_handling', language 'en'.
 *
...
$string['handling:manage'] = 'Manage user ordertotals manually';
$string['handling:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:handling_ordertotal'] = 'handling ordertotal messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'handling';
