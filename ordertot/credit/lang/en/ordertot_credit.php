...
/**
 * Strings for component 'ordertot_credit', language 'en'.
 *
...
$string['credit:manage'] = 'Manage user ordertotals manually';
$string['credit:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:credit_ordertotal'] = 'credit ordertotal messages';
$string['mapping'] = 'credit role mapping';
