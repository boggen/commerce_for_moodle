 ...
 */
class ordertot_credit_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('ordertot_credit/map_'.$role->id, $role->localname, '', $role->shortname);
    }
