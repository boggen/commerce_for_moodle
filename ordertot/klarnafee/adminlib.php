 ...
 */
class ordertot_klarnafee_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('ordertot_klarnafee/map_'.$role->id, $role->localname, '', $role->shortname);
    }
