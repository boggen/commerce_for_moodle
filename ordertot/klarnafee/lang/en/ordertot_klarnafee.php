...
/**
 * Strings for component 'ordertot_klarnafee', language 'en'.
 *
...
$string['klarnafee:manage'] = 'Manage user ordertotals manually';
$string['klarnafee:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:klarnafee_ordertotal'] = 'klarnafee ordertotal messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'klarnafee';
