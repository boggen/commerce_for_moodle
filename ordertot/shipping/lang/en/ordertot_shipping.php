...
/**
 * Strings for component 'ordertot_shipping', language 'en'.
 *
...
$string['shipping:manage'] = 'Manage user ordertotals manually';
$string['shipping:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:shipping_ordertotal'] = 'shipping ordertotal messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'shipping';
