...
/**
 * Strings for component 'ordertot_voucher', language 'en'.
 *
...
$string['voucher:manage'] = 'Manage user ordertotals manually';
$string['voucher:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:voucher_ordertotal'] = 'voucher ordertotal messages';
