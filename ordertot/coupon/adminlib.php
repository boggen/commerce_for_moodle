 ...
 */
class ordertot_coupon_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('ordertot_coupon/map_'.$role->id, $role->localname, '', $role->shortname);
    }
