...
/**
 * Strings for component 'ordertot_coupon', language 'en'.
 *
...
$string['coupon:manage'] = 'Manage user ordertotals manually';
$string['coupon:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:coupon_ordertotal'] = 'coupon ordertotal messages';
