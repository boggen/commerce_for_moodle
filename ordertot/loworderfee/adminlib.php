 ...
 */
class ordertot_loworderfee_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('ordertot_loworderfee/map_'.$role->id, $role->localname, '', $role->shortname);
    }
