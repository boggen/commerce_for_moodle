...
/**
 * Strings for component 'ordertot_loworderfee', language 'en'.
 *
...
$string['loworderfee:manage'] = 'Manage user ordertotals manually';
$string['loworderfee:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:loworderfee_ordertotal'] = 'loworderfee ordertotal messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'loworderfee';
