...
/**
 * Strings for component 'ordertot_reward', language 'en'.
 *
...
$string['reward:manage'] = 'Manage user ordertotals manually';
$string['reward:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:reward_ordertotal'] = 'reward ordertotal messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'reward';
