 ...
 */
class ordertot_reward_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('ordertot_reward/map_'.$role->id, $role->localname, '', $role->shortname);
    }
