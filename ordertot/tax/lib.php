...
/**
 * tax ordertotal plugin.
 *
 * This plugin lets the user specify a "tax" (CSV) containing ordertotal information.
...
/**
 * tax ordertotal plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ordertot_tax_plugin extends ordertot_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('ordertot/tax:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for tax ordertotals in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'ordertot/tax:manage'
    ...
    protected function get_ordertotler($courseid) {
        ...
        $users = get_ordertotled_users($context, 'ordertot/tax:manage');
        if (!$users) {
