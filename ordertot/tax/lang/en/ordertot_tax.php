...
/**
 * Strings for component 'ordertot_tax', language 'en'.
 *
...
$string['tax:manage'] = 'Manage user ordertotals manually';
$string['tax:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:tax_ordertotal'] = 'tax ordertotal messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'tax';
