 ...
 */
class ordertot_total_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('ordertot_total/map_'.$role->id, $role->localname, '', $role->shortname);
    }
