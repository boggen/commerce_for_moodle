...
/**
 * Strings for component 'ordertot_total', language 'en'.
 *
...
$string['total:manage'] = 'Manage user ordertotals manually';
$string['total:unordertot'] = 'Unordertot users from the course manually';
...
$string['messageprovider:total_ordertotal'] = 'total ordertotal messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'total';
