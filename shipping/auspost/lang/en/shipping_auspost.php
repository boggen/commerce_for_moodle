...
/**
 * Strings for component 'shipping_auspost', language 'en'.
 *
...
$string['auspost:manage'] = 'Manage user shipments manually';
$string['auspost:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:auspost_shipment'] = 'auspost shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'auspost';
