...
/**
 * auspost shipment plugin.
 *
 * This plugin lets the user specify a "auspost" (CSV) containing shipment information.
...
/**
 * auspost shipment plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class shipping_auspost_plugin extends shipping_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('shipping/auspost:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for auspost shipments in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'shipping/auspost:manage'
    ...
    protected function get_shippingler($courseid) {
        ...
        $users = get_shippingled_users($context, 'shipping/auspost:manage');
        if (!$users) {
