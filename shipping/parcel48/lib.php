...
/**
 * parcel48 shipment plugin.
 *
 * This plugin lets the user specify a "parcel48" (CSV) containing shipment information.
...
/**
 * parcel48 shipment plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class shipping_parcel48_plugin extends shipping_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('shipping/parcel48:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for parcel48 shipments in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'shipping/parcel48:manage'
    ...
    protected function get_shippingler($courseid) {
        ...
        $users = get_shippingled_users($context, 'shipping/parcel48:manage');
        if (!$users) {
