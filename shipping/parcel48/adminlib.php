 ...
 */
class shipping_parcel48_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('shipping_parcel48/map_'.$role->id, $role->localname, '', $role->shortname);
    }
