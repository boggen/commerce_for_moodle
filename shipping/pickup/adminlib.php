 ...
 */
class shipping_pickup_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('shipping_pickup/map_'.$role->id, $role->localname, '', $role->shortname);
    }
