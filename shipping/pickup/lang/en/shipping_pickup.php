...
/**
 * Strings for component 'shipping_pickup', language 'en'.
 *
...
$string['pickup:manage'] = 'Manage user shipments manually';
$string['pickup:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:pickup_shipment'] = 'pickup shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'pickup';
