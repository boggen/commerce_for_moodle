...
/**
 * Strings for component 'shipping_usps', language 'en'.
 *
...
$string['usps:manage'] = 'Manage user shipments manually';
$string['usps:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:usps_shipment'] = 'usps shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'usps';
