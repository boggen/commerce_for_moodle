...
/**
 * Strings for component 'shipping_flat', language 'en'.
 *
...
$string['flat:manage'] = 'Manage user shipments manually';
$string['flat:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:flat_shipment'] = 'flat shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'flat';
