 ...
 */
class shipping_flat_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('shipping_flat/map_'.$role->id, $role->localname, '', $role->shortname);
    }
