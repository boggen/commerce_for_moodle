...
/**
 * flat shipment plugin.
 *
 * This plugin lets the user specify a "flat" (CSV) containing shipment information.
...
/**
 * flat shipment plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class shipping_flat_plugin extends shipping_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('shipping/flat:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for flat shipments in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'shipping/flat:manage'
    ...
    protected function get_shippingler($courseid) {
        ...
        $users = get_shippingled_users($context, 'shipping/flat:manage');
        if (!$users) {
