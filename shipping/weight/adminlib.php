 ...
 */
class shipping_weight_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('shipping_weight/map_'.$role->id, $role->localname, '', $role->shortname);
    }
