...
/**
 * Strings for component 'shipping_weight', language 'en'.
 *
...
$string['weight:manage'] = 'Manage user shipments manually';
$string['weight:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:weight_shipment'] = 'weight shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'weight';
