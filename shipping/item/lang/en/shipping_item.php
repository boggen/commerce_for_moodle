...
/**
 * Strings for component 'shipping_item', language 'en'.
 *
...
$string['item:manage'] = 'Manage user shipments manually';
$string['item:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:item_shipment'] = 'item shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'item';
