 ...
 */
class shipping_citylink_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('shipping_citylink/map_'.$role->id, $role->localname, '', $role->shortname);
    }
