...
/**
 * Strings for component 'shipping_citylink', language 'en'.
 *
...
$string['citylink:manage'] = 'Manage user shipments manually';
$string['citylink:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:citylink_shipment'] = 'citylink shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'citylink';
