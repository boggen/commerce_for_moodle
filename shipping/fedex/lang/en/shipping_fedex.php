...
/**
 * Strings for component 'shipping_fedex', language 'en'.
 *
...
$string['fedex:manage'] = 'Manage user shipments manually';
$string['fedex:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:fedex_shipment'] = 'fedex shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'fedex';
