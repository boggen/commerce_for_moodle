 ...
 */
class shipping_free_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('shipping_free/map_'.$role->id, $role->localname, '', $role->shortname);
    }
