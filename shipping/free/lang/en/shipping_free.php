...
/**
 * Strings for component 'shipping_free', language 'en'.
 *
...
$string['free:manage'] = 'Manage user shipments manually';
$string['free:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:free_shipment'] = 'free shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'free';
