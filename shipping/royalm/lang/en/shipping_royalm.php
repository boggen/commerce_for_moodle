...
/**
 * Strings for component 'shipping_royalm', language 'en'.
 *
...
$string['royalm:manage'] = 'Manage user shipments manually';
$string['royalm:unshipping'] = 'Unshipping users from the course manually';
...
$string['messageprovider:royalm_shipment'] = 'royalm shipment messages';
$string['mapping'] = 'Flat file role mapping';
$string['pluginname'] = 'royal mail';
