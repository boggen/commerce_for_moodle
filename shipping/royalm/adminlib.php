 ...
 */
class shipping_royalm_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('shipping_royalm/map_'.$role->id, $role->localname, '', $role->shortname);
    }
