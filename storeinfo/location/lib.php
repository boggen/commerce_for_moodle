...
/**
 * location storemultiinfo plugin.
 *
 * This plugin lets the user specify a "location" (CSV) containing storemultiinfo information.
...
/**
 * location storemultiinfo plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class storeinfo_location_plugin extends storeinfo_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('storeinfo/location:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for location storemultiinfos in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'storeinfo/location:manage'
    ...
    protected function get_storeinfoler($courseid) {
        ...
        $users = get_storeinfoled_users($context, 'storeinfo/location:manage');
        if (!$users) {
