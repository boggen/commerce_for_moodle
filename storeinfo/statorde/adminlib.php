 ...
 */
class storeinfo_statorde_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('storeinfo_statorde/map_'.$role->id, $role->localname, '', $role->shortname);
    }
