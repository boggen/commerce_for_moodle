            ...
            <tbody>
              ...
              <tr id="tax-rule-row<?php echo $tax_rule_row; ?>">
                ...
                <td class="text-left"><select name="tax_rule[<?php echo $tax_rule_row; ?>][based]" class="form-control">
                    <?php  if ($tax_rule['based'] == 'storeinfo') { ?>
                    <option value="storeinfo" selected="selected"><?php echo $text_storeinfo; ?></option>
                    <?php } else { ?>
                    <option value="storeinfo"><?php echo $text_storeinfo; ?></option>
                    <?php } ?>
...
function addRule() {
    ...
    html += '    <option value="storeinfo"><?php echo $text_storeinfo; ?></option>';
