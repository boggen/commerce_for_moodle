...
/**
 * zone storemultiinfo plugin.
 *
 * This plugin lets the user specify a "zone" (CSV) containing storemultiinfo information.
...
/**
 * zone storemultiinfo plugin implementation.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class storeinfo_zone_plugin extends storeinfo_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('storeinfo/zone:manage', $context);
    }
    ...
    /**
     * Returns the user who is responsible for zone storemultiinfos in given curse.
     *
     * Usually it is the first editing teacher - the person with "highest authority"
     * as defined by sort_by_roleassignment_authority() having 'storeinfo/zone:manage'
    ...
    protected function get_storeinfoler($courseid) {
        ...
        $users = get_storeinfoled_users($context, 'storeinfo/zone:manage');
        if (!$users) {
