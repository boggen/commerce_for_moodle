 ...
 */
class storeinfo_taxrate_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('storeinfo_taxrate/map_'.$role->id, $role->localname, '', $role->shortname);
    }
