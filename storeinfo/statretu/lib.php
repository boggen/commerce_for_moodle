 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class storeinfo_statretu_plugin extends storeinfo_plugin {
    ...
    public function can_delete_instance($instance) {
        ...
        return has_capability('storeinfo/statretu:manage', $context);
    }
     ...
     * as defined by sort_by_roleassignment_authority() having 'storeinfo/statretu:manage'
    ...
    protected function get_storeinfoler($courseid) {
        ...
        $users = get_storeinfoled_users($context, 'storeinfo/statretu:manage');
        if (!$users) {
