 ...
 */
class storeinfo_statretu_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('storeinfo_statretu/map_'.$role->id, $role->localname, '', $role->shortname);
    }
