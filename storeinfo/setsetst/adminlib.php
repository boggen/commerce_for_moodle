 ...
 */
class storeinfo_setsetst_role_setting extends admin_setting_configtext {

    public function __construct($role) {
        parent::__construct('storeinfo_setsetst/map_'.$role->id, $role->localname, '', $role->shortname);
    }
